---
title: "Grundlagen zum Zwischenspeichern | AEM"
description: "Erfahren Sie, wie Dispatcher-Caching erfolgt und wie es in Adobe Experience Manager konfiguriert werden kann."
...
# Grundlagen zum Zwischenspeichern | AEM


In diesem Artikel erfahren Sie, wie Dispatcher-Caching erfolgt und wie Sie es konfigurieren können, indem Sie die folgenden standardmäßigen Cache-Verzeichnisse in Ihren Basisinstallationen verwenden -
...
Wichtig ist hier, dass die <b>/doroot</b> auf das Cache-Verzeichnis für den Autor festgelegt ist.
...
In einem Autorenszenario ändert sich der Inhalt ständig, und dies ist gewollt. Sie möchten nur Elemente zwischenspeichern, die sich nicht häufig ändern.
...
Auf AEM Systemen, die eine Menge Aktivität von Autoren haben, die viele Seitenaktivierungen durchführen, kann es zu einer Race-Bedingung kommen, bei der wiederholte Invalidierungen auftreten. Erheblich wiederholte Flush-Anfragen sind nicht erforderlich. Sie können eine Toleranz aufbauen, um einen Flush erst nach Ablauf der Übergangsphase zu wiederholen.

<b>Beispiel für die Funktionsweise:</b>
