...
description: Erfahren Sie, wie Sie Oak Lucene-Indizes optimieren können, um die Indizierungszeit zu verkürzen.
...
Optimieren Sie die Oak Lucene-Indizes mit den Eigenschaften includedPaths und excludedPaths .
...
3. Fügen Sie die unten hervorgehobenen Eigenschaften hinzu `[` 1`]`  zu den entsprechenden Indizes. Die` includedPaths `und` excludedPaths `-Eigenschaften sollten `multi-value String (String[ ] )`.
4. Klicks <b>Alle speichern</b> in CRXDe.
