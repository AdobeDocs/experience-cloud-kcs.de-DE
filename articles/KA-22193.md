---
title: "Die Größe eines Anfrage-Header-Felds überschreitet das Serverlimit"
description: "Erfahren Sie, wie Sie beim Öffnen einer Seite in AEM den Fehler \"Bad Request\" beheben können."
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: "KCS, Größe, Anfrage-Header, überschreiten, Serverlimit, AEM, Adobe Experience Manager, Fehlerbehebung, AEMaaCS, Adobe Experience Manager as a Cloud Service"
...
Erhöhen Sie den Wert für `#LimitRequestFieldSize` und `#LimitRequestLine` für AMS-/On-Premises-Versionen. Erhöhen Sie die <b>Anforderungsheader</b> begrenzen, indem Sie diese Eigenschaften auch zu den Vhost-Dateien für AEMaaCS hinzufügen.
...
Beim Öffnen einer Seite erhalten Benutzer eine &quot;<b>Ungültige Anfrage</b>&quot;Antwort mit der Nachricht:
...
Apache has a default `LimitRequestLine` of *8K*. Weitere Informationen finden Sie unter [Apache-Kernfunktionen: LimitRequestLine-Direktive](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) auf der Apache-Website.

Dieser Fehler kann behoben werden, indem der Wert für `#LimitRequestFieldSize` und `#LimitRequestLine`.

<u>Für AMS/On-Premise</u>:

Die Kopfzeilenbegrenzung kann in der Apache-Konfigurationsdatei erhöht werden - `httpd.conf`.
